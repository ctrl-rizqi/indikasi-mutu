...
export default async function TeknisiPage() {
  ...
  return (
    <main className="mx-auto w-full max-w-6xl space-y-6 px-6 py-10">
      <PageHeader
        title="Area Teknisi"
        description="Kelola aktivitas pengecekan item harian Anda."
      >
            ...
            <form action={createActivity}>
              <div className="grid gap-4 py-4">
                ...
                <div className="flex items-center space-x-2 rounded-md border p-3">
                  ...
                  />
                  <Label htmlFor="check1" className="cursor-pointer">Indikator 1 (Checklist 1)</Label>
                </div>
                ...
                <div className="flex items-center space-x-2 rounded-md border p-3">
                  <input
                    ...
                    className="size-4 rounded border-gray-300 text-primary focus:ring-primary"
                  />
                  <Label htmlFor="check2" className="cursor-pointer">Indikator 2 (Checklist 2)</Label>
                </div>
                ...
                <TableRow key={activity.id}>
                  ...
                  <TableCell>
                    <div className="flex flex-col">
                      <span className="font-medium">{activity.item.nama}</span>
                      {activity.keterangan && (
                  ...
                  <TableCell className="text-right pr-6">
                    <ActivityActions activity={activity} itemList={itemList} />
                  </TableCell>
                </TableRow>
              ))
            )}
